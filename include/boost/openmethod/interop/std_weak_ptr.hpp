...
// in `virtual_` is an ordinary parameter, and needs no specialization. The
// registry `virtual_` carries is a parameter of its own, so that a registry
// spelled on the parameter is diagnosed like the default one.
...
struct validate_method_parameter<
    virtual_<std::weak_ptr<T>, ParamRegistry>, Registry, void> :
...
template<typename T, class ParamRegistry, class Registry>
struct validate_method_parameter<
    virtual_<const std::weak_ptr<T>&, ParamRegistry>, Registry, void> :
    reject_weak_parameter<T> {};
...
template<typename T, class Registry, class ParamRegistry, class MethodRegistry>
struct validate_method_parameter<
    virtual_<weak_virtual_ptr<T, Registry>, ParamRegistry>, MethodRegistry,
    void> : reject_weak_parameter<T> {};
...
template<typename T, class Registry, class ParamRegistry, class MethodRegistry>
struct validate_method_parameter<
    virtual_<const weak_virtual_ptr<T, Registry>&, ParamRegistry>,
    MethodRegistry, void> : reject_weak_parameter<T> {};
