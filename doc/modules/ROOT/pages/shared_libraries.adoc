...
requirement with very little effort from the programmer. On Linux, it is just a
matter of tossing `-rdynamic` in the linker options, or adding `ENABLE_EXPORTS
ON` to the library's target properties if using `cmake`.
