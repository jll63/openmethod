...
that list. It scans one or more namespaces for the registry's methods, and
registers the classes they dispatch on along with everything in those
namespaces that derives from them:
