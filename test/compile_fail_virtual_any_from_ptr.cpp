...
int main() {
    ...
    virtual_any_ptr<std::any> ref(dog);

    // A virtual_any cannot be copy-initialized from a virtual_any_ptr. The
    ...
    // virtual_any_ptr to std::any, then std::any to virtual_any - which is
